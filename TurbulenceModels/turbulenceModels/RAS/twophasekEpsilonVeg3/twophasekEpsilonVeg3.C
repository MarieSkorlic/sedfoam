...
void twophasekEpsilonVeg3<BasicTurbulenceModel>::correctNut()
{
	this->nut_ = Cmu_*sqr(ks_ + kw_)/(epsilons_ + epsilonw_);
...
template<class BasicTurbulenceModel>
twophasekEpsilonVeg3<BasicTurbulenceModel>::twophasekEpsilonVeg3
(
...
template<class BasicTurbulenceModel>
bool twophasekEpsilonVeg3<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void twophasekEpsilonVeg3<BasicTurbulenceModel>::correct()
{
