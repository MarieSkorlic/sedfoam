...
void twophasekOmegaVeg3<BasicTurbulenceModel>::correctNut()
{
    this -> nut_ = (kw_/omegaw_) + (ks_/omegas_);
...
template<class BasicTurbulenceModel>
twophasekOmegaVeg3<BasicTurbulenceModel>::twophasekOmegaVeg3
(
...
template<class BasicTurbulenceModel>
bool twophasekOmegaVeg3<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void twophasekOmegaVeg3<BasicTurbulenceModel>::correct()
{
